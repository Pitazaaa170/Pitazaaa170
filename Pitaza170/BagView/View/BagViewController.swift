...
//        
//        cell.configure(name: self.employers?[firstChar]![indexPath.row].name ?? "", phone:
//self.employers?[firstChar]![indexPath.row].number ?? "", skills: self.employers?[firstChar]![indexPath.row].skills ?? [])
